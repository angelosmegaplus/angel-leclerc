...
function AdminNewsPage() {
  ...
  return (
    <main
      className="min-h-[100dvh] overflow-x-hidden bg-black px-3 pb-[calc(2rem+env(safe-area-inset-bottom))] pt-[calc(1rem+env(safe-area-inset-top))] text-white sm:px-7 lg:px-10"
      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <header className="sticky top-0 z-20 -mx-3 mb-4 border-b border-white/10 bg-black/95 px-3 pb-4 pt-2 backdrop-blur sm:-mx-7 sm:px-7 lg:-mx-10 lg:px-10">
          <div className="flex min-w-0 items-center gap-3">
            <Link
              to="/admin"
              className="grid h-11 w-11 shrink-0 place-items-center border border-white/20 text-white transition-colors hover:border-white/40"
              aria-label="Retour à Angel OS"
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex min-w-0 items-center gap-2">
                <Newspaper className="h-6 w-6 shrink-0 text-white/65" />
                <h1 className="truncate text-2xl font-light tracking-[-0.025em] sm:text-4xl">actualités</h1>
              </div>
            </div>
          </div>
        ...
        <div className="border-l-4 border-[#0078d7] bg-[#111] p-4 text-sm font-light leading-relaxed text-white/65">
          Veille générale et personnalisée : politique, radio et médias, journalisme et communication, IA et technologie, Sarlat/Dordogne et opportunités d'emploi ou d'alternance.
        </div>
