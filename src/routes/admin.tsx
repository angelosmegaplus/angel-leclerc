...
function AdminPage() {
  ...
  const navItems: AdminNavItem[] = [
    ...
    { key: "agenda", label: "Agenda", icon: CalendarDays, group: "Planning", primary: true },
    { key: "projets", label: "Projets & tâches", icon: FolderKanban, group: "Planning", primary: true },
    { key: "messages", label: "Messages", icon: Mail, badge: unreadCount, group: "Messages", primary: true },
    { key: "abonnes", label: "Contacts", icon: Users, badge: subscribers.length, group: "Messages" },
    { key: "avis", label: "Avis", icon: Star, group: "Messages" },
    { key: "boite-mail", label: "Boîte mail", icon: Inbox, group: "Messages" },
    { key: "signature", label: "Signature", icon: PenLine, group: "Messages" },
