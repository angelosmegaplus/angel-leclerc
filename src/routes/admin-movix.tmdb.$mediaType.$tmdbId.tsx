...
import { ArrowLeft, ExternalLink, Loader2, Play, Star } from "lucide-react";
    ...
    <div className="mx-auto max-w-[1320px] px-4 py-8 sm:px-8 lg:px-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
        ...
        <aside className="h-fit space-y-4 lg:sticky lg:top-5">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[.025] p-5"><p className="text-[10px] uppercase tracking-[.14em] text-white/35">Source</p><p className="mt-2 text-sm text-white/75">TMDB #{detail.tmdbId}</p><p className="mt-1 text-xs leading-5 text-white/35">Données chargées côté serveur via le pool automatique de clés Angel OS.</p></section>
        </aside>
      </div>
    </div>
  </main>;
