      ...
      <section className="section-padding">
        <div className="container-tight">
          ...
          <AnimatedSection delay={0.12} className="mt-6">
            <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-center gap-2 text-sm text-muted-foreground">
            ...
            <div className="mx-auto max-w-2xl rounded-xl border border-border bg-card p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm leading-relaxed text-muted-foreground">
                  ...
                  <p className="mt-1">
                    Si vous n'obtenez pas de réponse ou si l'envoi échoue, le plus
                    simple reste de m'écrire directement par e-mail ou de m'appeler.
                  </p>
