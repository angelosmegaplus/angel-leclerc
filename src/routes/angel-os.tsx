...
export const Route = createFileRoute("/angel-os")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Angel OS centralise l'administration, l'intelligence artificielle, les communications, l'agenda, les fichiers, les candidatures et les automatisations dans une interface privée." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Angel OS" },
      { property: "og:description", content: "Application personnelle de centralisation, d'assistance et d'automatisation." },
    ],
...
const features = [
  ...
  [Mail, "Communications", "L'application peut connecter des services comme Gmail afin de consulter et traiter les communications demandées par l'utilisateur."],
  ...
  [Database, "Fichiers et données", "Des services comme Google Drive peuvent être utilisés pour accéder aux fichiers choisis et assurer certaines fonctions de stockage ou de sauvegarde."],
] as const;
      ...
      <section className="border-y border-border bg-muted/30">
        <div className="container-tight py-14 md:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-muted-foreground">L'accès peut être révoqué depuis le compte Google. Les détails sur les données, leurs finalités, leur conservation et les droits applicables sont décrits dans la politique de confidentialité.</p>
            <Link to="/politique-confidentialite" className="mt-5 inline-flex items-center gap-2 font-semibold text-primary hover:underline">Consulter la politique de confidentialité <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </div>
      </section>
    </main>
