...
export const SubscribeWelcomeEmail = ({
  ...
  >
    ...
    <Text style={textStyle}>
      Merci de votre intérêt. Il reste une étape : confirmez votre adresse e-mail pour recevoir
    ...
    <Text style={textStyle}>
      <strong>Comment ça marche&nbsp;?</strong> Une seule lettre par semaine, le dimanche soir,
      avec les articles publiés dans la semaine. Aucun envoi si aucun article n'a été publié.
    </Text>
