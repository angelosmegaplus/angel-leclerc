...
export const OrderConfirmationEmail = ({
  ...
  >
    ...
    <Text style={textStyle}>
      Votre paiement est confirmé. Votre commande part en production chez notre
      atelier d'impression, puis vous sera expédiée sous 5 à 10 jours ouvrés.
    </Text>
    {orderRef && (
    ...
    {total && (
      <Text style={{ ...textStyle, fontWeight: 700 }}>Total payé : {total}</Text>
    )}
    {shippingAddress && (
