  ...
  >
    ...
    {trackingNumber && (
      <Text style={{ ...textStyle, color: muted }}>
        Numéro de suivi :{' '}
        <strong style={{ color: '#181716' }}>{trackingNumber}</strong>
      </Text>
    )}
    ...
    <Text style={{ ...textStyle, fontSize: 12, color: muted, margin: '18px 0 0 0' }}>
      Le suivi peut mettre quelques heures à s'activer chez le transporteur. Une
      question ? Répondez simplement à cet e-mail.
    </Text>
