  ...
  return (
    <div className="min-h-[100dvh] w-full overflow-x-hidden bg-[#050607] text-white lg:flex" style={{ fontFamily: '"Inter", system-ui, sans-serif' }}>
      ...
      <div className="relative z-10 min-w-0 flex-1">
        ...
        <div className="fixed bottom-[calc(.75rem+env(safe-area-inset-bottom))] left-1/2 z-30 flex h-16 w-[min(44rem,calc(100vw-1.5rem))] -translate-x-1/2 items-center rounded-full border border-white/10 bg-[#090b0d]/95 shadow-[0_12px_40px_rgba(0,0,0,.55)] backdrop-blur-xl lg:w-[min(46rem,calc(100vw-22rem))]">
