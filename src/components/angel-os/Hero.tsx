      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid items-center gap-12 pt-14 lg:grid-cols-[1.1fr_.9fr] lg:pt-20">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-xl font-medium text-white/85 sm:text-2xl">Une architecture numérique modulaire conçue pour centraliser, orchestrer et automatiser les opérations du site et de ses services associés.</p>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/55 sm:text-lg">Angel OS combine intelligence artificielle, automatisations planifiées, composants applicatifs et services connectés au sein d’un même environnement. Les instructions peuvent être déclenchées depuis ChatGPT ou l’espace d’administration, tandis que des processus autonomes assurent la veille, les vérifications, la maintenance et l’exécution d’actions récurrentes.</p>
